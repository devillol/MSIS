...
1.  
    ...
    - Наблюдается незначительная зависимость **концентрации** от
    зенитного угла (колебания значений до 60%), широты и времени года (колебания значений до 50%)
    , а также зависимость значений концентрации от солнечной активности
    (в пределах 12%)
2.
    ...
    - Средние значения **концентрации** нейтралов близки к наиболее вероятным в экваториальных и полярных широтах, 
     но в средних широтах различия достигают 12%
