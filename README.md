...
температуры от солнечной активности не наблюдается. Значения колеблются в пределах 8%.
...
## Выводы 
1.  
    - Распределение **температуры** нейтралов зависит от широты, времени года и зенитного угла. Также наблюдается зависимость
