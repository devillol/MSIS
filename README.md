...
Тем не менее, наиболее вероятные значения близки к средним (в переделах 1.25%).
...
температуры от солнечной активности не наблюдается. Значения колеблются в пределах 6%.
...
значения практически совпадают со средними (отклонение десятичного логарифма менее 1%).
...
Летом и зимой разброс больше, чем в межсезонье.
...
Ярко выражена зависимость температуры нейтралов от сезона.
...
Видно, что концентрация нейтралов зависит от времени года.
...
Модель распределения концентрации нейтралов немного отличается от рассчитанной, а распределение температуры нейтралов не
совпадает совсем.

## Выводы 
1.  
    - Распределение **температуры** нейтралов существенно зависит от широты и времени года. Также наблюдается зависимость
    от зенитного угла и солнечной активности. 
    - Распределение **концентрации** нейтралов зависит от широты и времени года, а зависимость от зенитного угла и
    солнечной активности несущественна.
2.
    - Средние значения **температуры** нейтралов при некоторых гелиофизических условиях отличаются от наиболее вероятных,
    следовательно, необходим переход к вероятностным характеристикам.
    - Средние значения **концентрации** нейтралов в большинстве случаев близки к наиболее вероятным, следовательно,
    переход к вероятностным характеристикам не критичен.
3.  Рассчитанные T и M на данных со спутника отличаются от модели MSIS, из чего можно сделать вывод, что модель
MSIS неприменима для решения задач моделирования ионосферных слоев. 
