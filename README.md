...
При высокой СА диспеерсия значений больше, чем при низкой. При этом, во всех случаях наиболее вероятные
значения совпадают со средними.

Построим зависимость распределения средней и наиболее вероятной концентрации нейтралов
...
наблюдается наибольший разброс зенитных углов.
