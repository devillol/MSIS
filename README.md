...
различия средней и вероятной концентрации до 50%.
...
Для концентрации модель совпадает с рассчитанной в пределах одного порядка (десятичные логарифмы отличаются менее, чем на 0.3).
...
3.  Рассчитанные M на данных со спутника отличаются от модели MSIS в пределах одного порядка (
 десятичные логарифмы расходятся менее, чем на 0.3), а модель T отличается от данных со спутника
